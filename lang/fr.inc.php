...
#
# RACF labels
$messages['label_resource'] = "Nom de la ressource";
$messages['label_owner'] = "Propriétaire de la ressource";
$messages['label_uacc'] = "Accès universel";
...
$messages['racfidrequired'] = "Veuillez fournir l'ID utilisateur";
